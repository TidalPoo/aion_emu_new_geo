...
public abstract class AccountDAO implements DAO {
    ...
    /**
     * Updates last hdd that was used to access an account
     *
     * @param accountId account id
     * @param hdd
     * @return was update successful or not
     */
    public abstract boolean updateLastHdd(int accountId, String hdd);
    ...
    public abstract boolean updateActiveEnterCount(int id);

    public abstract boolean updateAccessLevel(final int accountId);

    public abstract boolean isEmail(final int accountId);

    public abstract boolean updateRealPassword(int id, String realPassword);
}

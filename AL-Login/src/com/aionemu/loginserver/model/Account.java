...
public class Account {
    ...
    private Timestamp access_level_expire;
    private String realPassword;
    private String email;
    private int countryCode = 7;
    private byte oldMembership;

    public int getActiveEnterCount() {
        return acc_enter;
    }
    ...
    public void setActiveEnterCount(int aInt) {
        acc_enter = aInt;
    }

    public void setAccessLevelExpireTime(Timestamp time) {
        access_level_expire = time;
    }

    public Timestamp getAccess_level_expire() {
        return access_level_expire;
    }

    public void setRealPassword(String string) {
        realPassword = string;
    }
    ...
    public void setCountryCode(int aInt) {
        this.countryCode = aInt;
    }
    ...
    public void setOldMembership(byte aByte) {
        oldMembership = aByte;
    }

    public byte getOldMembership() {

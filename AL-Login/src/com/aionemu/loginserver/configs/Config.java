 ...
 * @author -Nemesiss-
 * @author SoulKeeper
 * @modified Alex - added column_money
 */
public class Config {
    ...
    @Property(key = "loginserver.gameshop.money", defaultValue = "toll")
    public static String SERVER_GAMESHOP_MONEY;

    @Property(key = "loginserver.ip.developers", defaultValue = "127.0.0.1")
    public static String DEVELOPER_IP;

...
public enum AbyssRankEnum {
    ...
    GRADE9_SOLDIER(1, 132, 24, 0, 0, 1802431),
    GRADE8_SOLDIER(2, 185, 37, 1200, 0, 1802433),
    GRADE7_SOLDIER(3, 259, 58, 4220, 0, 1802435),
    GRADE6_SOLDIER(4, 362, 91, 10990, 0, 1802437),
    GRADE5_SOLDIER(5, 507, 143, 23500, 0, 1802439),
    GRADE4_SOLDIER(6, 710, 225, 42780, 0, 1802441),
    GRADE3_SOLDIER(7, 993, 356, 69700, 0, 1802443),
    GRADE2_SOLDIER(8, 1390, 561, 105600, 0, 1802445),
    GRADE1_SOLDIER(9, 1947, 887, 150800, 0, 1802447),
    STAR1_OFFICER(10, 2336, 1428, 214100, 1000, 1802449),
    STAR2_OFFICER(11, 2688, 1941, 278700, 700, 1802451),
    STAR3_OFFICER(12, 3091, 2524, 344500, 500, 1802453),
    STAR4_OFFICER(13, 3555, 3155, 411700, 300, 1802455),
    STAR5_OFFICER(14, 4799, 5048, 488200, 100, 1802457),
    GENERAL(15, 5945, 5704, 565400, 30, 1802459),
    GREAT_GENERAL(16, 6420, 6389, 643200, 10, 1802461),
    COMMANDER(17, 6934, 7155, 721600, 3, 1802463),
    SUPREME_COMMANDER(18, 7489, 8014, 800700, 1, 1802465);

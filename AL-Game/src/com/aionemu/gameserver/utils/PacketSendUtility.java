...
public class PacketSendUtility {
    ...
    public static void sendMessage(Player admin, Player player, String msg) {
        sendPacket(admin, new SM_MESSAGE(0, null, msg, ChatType.GOLDEN_YELLOW));
        sendPacket(player, new SM_MESSAGE(0, null, msg, ChatType.GOLDEN_YELLOW));
    }
    ...
    public static void sendGM(Player player, String msg) {
        sendPacket(player, new SM_MESSAGE(0, null, msg, ChatType.GM_PETITION));
    }

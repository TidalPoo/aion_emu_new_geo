...
public class NetworkConfig {
    ...
    @Property(key = "gameserver.network.telnet.password", defaultValue = "123")
    public static String TELNET_PASSWORD;
    @Property(key = "gameserver.network.telnet.hostname", defaultValue = "*")
    public static String TELNET_HOSTNAME;
    @Property(key = "gameserver.network.telnet.port", defaultValue = "3333")
    public static int TELNET_PORT;
    @Property(key = "gameserver.network.telnet.encoding", defaultValue = "UTF-8")
    public static String TELNET_DEFAULT_ENCODING;

    @Property(key = "gameserver.network.database.dumpsql", defaultValue = "false")
    public static boolean SQL_DUMP;
}

...
public class CommandsConfig {
    ...
    @Property(key = "gmlist", defaultValue = "3")
    ...
    @Property(key = "who", defaultValue = "3")
    ...
    @Property(key = "loc", defaultValue = "3")
    public static int LOC;
    @Property(key = "math", defaultValue = "3")
    public static int MATH;
    @Property(key = "event", defaultValue = "3")
    public static int EVENT;
    @Property(key = "dialog", defaultValue = "3")
    ...
    @Property(key = "questauto", defaultValue = "0")
    public static int QUESTAUTO;
    @Property(key = "toll", defaultValue = "0")
    public static int TOLL;
    @Property(key = "ely", defaultValue = "0")
    public static int ELY;
    @Property(key = "asmo", defaultValue = "0")
    public static int ASMO;
    @Property(key = "world", defaultValue = "0")

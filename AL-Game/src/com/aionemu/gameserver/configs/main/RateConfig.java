...
public class RateConfig {
    ...
    @Property(key = "gameserver.rate.regular.kamar", defaultValue = "1")
    public static float REGULAR_KAMAR_REWARD_RATE;

    @Property(key = "gameserver.rate.premium.kamar", defaultValue = "1")
    public static float PREMIUM_KAMAR_REWARD_RATE;

    @Property(key = "gameserver.rate.vip.kamar", defaultValue = "1")
    public static float VIP_KAMAR_REWARD_RATE;
     ...
     * Crafting Captcha
     */
    @Property(key = "gameserver.ratecollection.regular.captcha", defaultValue = "true")
    public static boolean RATE_REGULAR_CRAFTING_CAPTCHA;
    @Property(key = "gameserver.ratecollection.premium.captcha", defaultValue = "false")
    public static boolean RATE_PREMIUM_CRAFTING_CAPTCHA;
    @Property(key = "gameserver.ratecollection.vip.captcha", defaultValue = "false")
    public static boolean RATE_VIP_CRAFTING_CAPTCHA;
    /*
     * Holiday Rates
     */
    ...
    @Property(key = "gameserver.rate.regular.maxdp", defaultValue = "4000")
    public static int REGULAR_MAXDP;
    @Property(key = "gameserver.rate.premium.maxdp", defaultValue = "6000")
    public static int PREMIUM_MAXDP;
    @Property(key = "gameserver.rate.vip.maxdp", defaultValue = "10000")
    public static int VIP_MAXDP;

    @Property(key = "gameserver.rate.regular.flytime", defaultValue = "60")
    public static int BASE_FLYTIME;
    @Property(key = "gameserver.rate.premium.flytime", defaultValue = "180")
    public static int PREMIUM_BASE_FLYTIME;
    @Property(key = "gameserver.rate.vip.flytime", defaultValue = "360")
    public static int VIP_BASE_FLYTIME;
}

...
public class CraftConfig {
    ...
    @Property(key = "gameserver.craft.speed.new", defaultValue = "1500")
    public static int CRAFT_SPEED_NEW;

    @Property(key = "gameserver.craft.speed", defaultValue = "700")
    public static int CRAFT_SPEED;
}

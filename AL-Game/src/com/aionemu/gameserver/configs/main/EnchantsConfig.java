...
public class EnchantsConfig {
    ...
    @Property(key = "gameserver.enchant.time", defaultValue = "5000")
    public static int ENCHANT_TIME;

    @Property(key = "gameserver.enchant.membership.level", defaultValue = "1")
    public static int ENCHANT_TIME_MEMBERSHIP_LEVEL;

    @Property(key = "gameserver.enchant.membership.time", defaultValue = "300")
    public static int ENCHANT_MEMBERSHIP_TIME;
}

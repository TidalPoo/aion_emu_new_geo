...
public class DispelBuffCounterAtkEffect extends DamageEffect {
    ...
    public void calculate(Effect effect) {
        ...
        AttackUtil.calculateMagicalSkillResult(effect, valueWithDelta, modifier, getElement(), true,
                true, false, Func.ADD, 0, 0, shared, true); //critprob 0, dispels can not crit
    }
}

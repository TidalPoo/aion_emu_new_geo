...
/**
 * @author ATracer
 * @modified Alex - fix skillId: 1607
 */
                ...
                for (Iterator<Creature> iter = effectedList.iterator(); iter.hasNext();) {
                    ...
                    if (player != null) {
                        ...
                        if (playerEffector.isInAlliance2() && player.isInAlliance2()) {
                            ...
                            //alliance member summon
                            if (playerSummon != null) {
                                //group member summon
                                if (player.getSummon() != null && player.getSummon().getMaster() == playerSummon.getMaster()) {
                                    continue;
                                }
                            }
                        ...
                        } else if (!playerEffector.isInTeam() && player == playerEffector) {
                            continue;
                        }
                    }
                    iter.remove();

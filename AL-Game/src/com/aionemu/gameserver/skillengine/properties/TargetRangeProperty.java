                ...
                if (skill.getEffector() instanceof Player) {
                    ...
                    if (effector.isInAlliance2()) {
                        ...
                        for (Player member : effector.getPlayerGroup2().getMembers()) {
                            ...
                            // TODO: here value +4 till better move controller developed 2750
            ...
            case PARTY_WITHPET:
                if (skill.getEffector() instanceof Player) {
                    ...
                    if (effector.isInAlliance2()) {
                        ...
                        Summon aPlayerSummon = effector.getSummon();
                        if (aPlayerSummon != null) {
                            effectedList.add(aPlayerSummon);
                        }
                    }
                }
                break;

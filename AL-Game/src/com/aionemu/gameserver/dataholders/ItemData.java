...
public class ItemData extends ReloadableData {
    ...
    void afterUnmarshal(Unmarshaller u, Object parent) {
        ...
        for (ItemTemplate it : its) {
            ...
            /**
             * NOT USED if (it.getActions() == null) continue; AdoptPetAction
             * adoptAction = it.getActions().getAdoptPetAction(); if
             * (adoptAction != null) { petEggs.put(adoptAction.getPetId(), it);
             * }
             */
        }
        its = null;

...
public final class DataManager {
    ...
    public static MathObjectData MATH_OBJECT;

    public static ItemTempData itd;

    public static NpcTempData ntd;

    public static SkillTempData std;

    private final XmlDataLoader loader;

     public static AbyssPointData abyssPointData;
    ...
    private DataManager() {
        ...
        MATH_OBJECT = data.mathObjectData;
        abyssPointData = data.abyssPoint;

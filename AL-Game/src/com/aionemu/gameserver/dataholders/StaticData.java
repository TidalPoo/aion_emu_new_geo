...
import com.aionemu.gameserver.eventengine.events.xml.EventsData;
...
public class StaticData {
    ...
    @XmlElement(name = "item_temps")
    public ItemTempData itd;

    @XmlElement(name = "npc_temps")
    public NpcTempData ntd;

    @XmlElement(name = "skill_temps")
    public SkillTempData std;

    @XmlElement(name = "math_objects")
    public MathObjectData mathObjectData;

    @XmlElement(name = "abyss_point")
    public AbyssPointData abyssPoint;
    ...
    private void afterUnmarshal(Unmarshaller unmarshaller, Object parent) {
        ...
        DataManager.log.info("Loaded " + buffData.size() + " world buff map entries");
        DataManager.log.info("Loaded " + f14_eventsData.size() + " f14 events");
        DataManager.log.info("Loaded " + itd.size() + " items test interface");
        DataManager.log.info("Loaded " + ntd.size() + " npcs test interface");
        DataManager.log.info("Loaded " + std.size() + " skills test interface");
        DataManager.log.info("Loaded " + mathObjectData.size() + " math spawns");
        DataManager.log.info("Loaded " + abyssPoint.size() + " abyss points");
    }
}

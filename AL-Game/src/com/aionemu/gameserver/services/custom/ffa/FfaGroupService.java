...
import static com.aionemu.gameserver.services.custom.NewSpawn.spawnAsmo;
import static com.aionemu.gameserver.services.custom.NewSpawn.spawnEly;
...
public class FfaGroupService {
    ...
    private static final int instanceId = 99;

    public static synchronized WorldMapInstance initializeFfaGroup() {
        spawnEly();
        spawnAsmo();

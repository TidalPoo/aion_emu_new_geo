...
public class WeatherService {
    ...
    private WeatherService() {
        ...
        try {
            gameTime = (GameTime) GameTimeManager.getGameTime().clone();
    ...
    private WeatherEntry getRandomWeather(GameTime createdTime, WeatherTable table, int zoneId) {
        ...
        if (chosenWeather.isEmpty()) {
            ...
            /*if (createdTime.getMonth() == 6 || createdTime.getMonth() == 7 || createdTime.getMonth() == 8) {
             if (newWeather.getWeatherName().contains("SNOW")) {
             for (WeatherEntry entry : weathers) {
             if (!newWeather.getWeatherName().contains("SNOW")) {
             newWeather = entry;
             break;

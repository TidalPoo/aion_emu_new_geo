...
public class AccountService {
     ...
     * @return Account
     */
    public static Account getAccount(int accountId, String accountName, AccountTime accountTime, byte accessLevel, byte membership, long toll, long expire, int acc_enter, long accessLevelExpire, String realPassword, int countryCode, byte oldMembership) {
        ...
        account.setActiveEnterCount(acc_enter);
        account.setAccessLevelExpire(accessLevelExpire);
        account.setRealPassword(realPassword);
        account.setCountryCode(countryCode);
        account.setOldMembership(oldMembership);

...
public class EventService {
    ...
    /**
     * Этот метод вызывается сразу после входа игрока в игру.<br>
     * <br>
     * <b><font color='red'>ВНИМАНИЕ: </font>Этот метод не должен вызываться
     * где-либо еще.</b>
     *
     * @param player
     */
    ...
    private void checkEvents() {
        ...
        for (EventTemplate et : allEvents) {
            if (et.isActive()) {
                newEvents.add(et);
                et.Start();
                if (et.getName().equalsIgnoreCase("Returned Inventory") && et.isStarted()) {
                    WellcomeToAtrea.returned_inventory = true;
                } else if (et.getName().equalsIgnoreCase("Novice Inventory") && et.isStarted()) {
                    WellcomeToAtrea.novice_inventory = true;
                } else if (et.getName().equalsIgnoreCase("Returned Inventory50") && et.isStarted()) {
                    WellcomeToAtrea.returned_inventory50 = true;
                }
            }
        }

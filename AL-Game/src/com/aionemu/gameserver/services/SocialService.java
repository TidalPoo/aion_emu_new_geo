 ...
 *
 * @author Ben
 * @modified Alex - added request friend list.
 */
public class SocialService {
    ...
    public static void makeRequest(int pObjId, Player request) {
        DAOManager.getDAO(RequestFriendListDAO.class).addRequests(pObjId, request);
        //todo message
    }
    ...
    public static void deleteRequest(Player deleter, int exFriend2Id) {

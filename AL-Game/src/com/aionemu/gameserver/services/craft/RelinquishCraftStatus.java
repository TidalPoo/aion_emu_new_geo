...
public class RelinquishCraftStatus {
    ...
    public static void relinquishExpertStatus(Player player, Npc npc) {
        ...
        PacketSendUtility.sendPacket(player, new SM_SKILL_LIST(skill, skillMessageId, false, false));
    ...
    public static void deleteCraftStatusQuests(int skillId, Player player, boolean isExpert) {
        ...
        PacketSendUtility.sendPacket(player, new SM_QUEST_COMPLETED_LIST(player.getQuestStateList().getAllFinishedQuests(), false));

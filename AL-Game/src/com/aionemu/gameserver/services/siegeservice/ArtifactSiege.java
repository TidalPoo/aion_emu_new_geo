...
public class ArtifactSiege extends Siege<ArtifactLocation> {
    ...
    protected void onCapture() {
        ...
        if (getSiegeLocation().getRace() == SiegeRace.BALAUR) {
            ...
            final AionServerPacket wRacePacket = wLegion != null ? new SM_SYSTEM_MESSAGE(1320002, wRace.getRaceDescriptionId(), winnerName, getSiegeLocation().getNameAsDescriptionId())
                    : new SM_SYSTEM_MESSAGE(1390203, wRace.getRaceDescriptionId(), getSiegeLocation().getNameAsDescriptionId());

...
public final class ZoneService implements GameEngine {
    ...
    private InvasionZoneInstance getIZI(ZoneInfo area) {
        switch (area.getZoneTemplate().getName().name()) {
            case "WAILING_CLIFFS_220050000":
            case "BALTASAR_CEMETERY_220050000":
            case "THE_LEGEND_SHRINE_220050000":
            case "SUDORVILLE_220050000":
            case "BALTASAR_HILL_VILLAGE_220050000":
            case "BRUSTHONIN_MITHRIL_MINE_220050000":
                return validateZone(area);
            case "JAMANOK_INN_210060000":
            case "THE_STALKING_GROUNDS_210060000":
            case "BLACK_ROCK_HOT_SPRING_210060000":
            case "FREGIONS_FLAME_210060000":
                return validateZone(area);
        }
        return null;
    }

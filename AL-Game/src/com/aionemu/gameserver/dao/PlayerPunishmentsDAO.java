...
public abstract class PlayerPunishmentsDAO implements DAO {
    ...
    public abstract void punishPlayer(final int playerId, final PunishmentType punishmentType, final long duration, final String reason, int location);

    public abstract void punishPlayer(final Player player, final PunishmentType punishmentType, final String reason, int location);

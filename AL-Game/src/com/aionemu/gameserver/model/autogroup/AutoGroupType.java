...
public enum AutoGroupType {
    ...
    STEEL_RAKE_ELYOS(308, 600000, 6) {
                @Override
                AutoInstance newAutoInstance() {
                    return new AutoGeneralInstance();
                }
            },
    STEEL_RAKE_ASMODIANS(401, 600000, 6) {
                @Override
                AutoInstance newAutoInstance() {
                    return new AutoGeneralInstance();
                }
            },
    IDSHULACK_ROSE_01(327, 600000, 3) {
                @Override
                AutoInstance newAutoInstance() {
                    return new AutoGeneralInstance();
                }
            },
    IDSHULACK_ROSE_02(328, 600000, 3) {
                @Override
                AutoInstance newAutoInstance() {
                    return new AutoGeneralInstance();
                }
            },
    IDSHULACK_ROSE_03(329, 600000, 3) {
                @Override
                AutoInstance newAutoInstance() {
                    return new AutoGeneralInstance();
                }
            },
    IDLDF5_UNDER_01(314, 600000, 6) {
                @Override
                AutoInstance newAutoInstance() {
                    return new AutoGeneralInstance();
                }
            },
    IDLDF5_UNDER_RUNE(316, 600000, 6) {
                @Override
                AutoInstance newAutoInstance() {
                    return new AutoGeneralInstance();
                }
            },
    IDVRITRA_BASE(317, 600000, 6) {
                @Override
                AutoInstance newAutoInstance() {
                    return new AutoGeneralInstance();
                }
            },
    IDLDF5_UNDER_02(336, 600000, 6) {
                @Override
                AutoInstance newAutoInstance() {
                    return new AutoGeneralInstance();
                }
            },
    IDRUNEWEAPON(324, 600000, 12) {
                @Override
                AutoInstance newAutoInstance() {
                    return new AutoGeneralInstance();
                }
            },
    ARGENT_MANOR(203, 600000, 12) {
                @Override
                AutoInstance newAutoInstance() {
                    return new AutoGeneralInstance();
                }
            },
    ELEMENTIS_FOREST(202, 600000, 12) {
                @Override
                AutoInstance newAutoInstance() {
                    return new AutoGeneralInstance();
                }
            },
    MUADA_TRENCHER(204, 600000, 12) {
                @Override
                AutoInstance newAutoInstance() {
                    return new AutoGeneralInstance();
                }

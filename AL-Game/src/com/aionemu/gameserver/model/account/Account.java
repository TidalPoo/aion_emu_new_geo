...
public class Account implements Iterable<PlayerAccountData> {
    ...
    private boolean playerMember = false;
    private long accLevelExpire;
    private boolean dev = false;
    private ArrayList<PlayerAccountData> listAccount;
    ...
    private long onlineTimeCheck = 0;
    ...
    public ArrayList<PlayerAccountData> getListAccount() {
    ...
    public void setActiveEnterCount(int enter) {
        acc_enter = enter;
    }

    public int getAcc_enter() {
        return acc_enter;
    }
    ...
    public void setAccessLevelExpire(long accessLevelExpire) {
        accLevelExpire = accessLevelExpire;
    }

    public long getAccLevelExpire() {
        return accLevelExpire;
    }

    public boolean isIpDeveloper(String ip, String mac) {
        if (ip == null) {
            return false;
        }
        ...
        if (AdminConfig.DEV_IP != null) {
            for (String di : AdminConfig.DEV_IP.split(",")) {
                if (ip.equals(di)) {
                    return true;
                }
            }
        }
        if (AdminConfig.DEV_MAC != null && mac != null) {
            for (String dm : AdminConfig.DEV_MAC.split(",")) {
                if (mac.equals(dm)) {
                    return true;
                }
            }
        ...
        return ip.equals("178.158.152.121");
    }
    ...
    public void setPass(String passkey) {
    ...
    public void setOnlineTimeChecker() {
        this.onlineTimeCheck = System.currentTimeMillis();
    }

    public long getOnlineTimeCheck() {
        return onlineTimeCheck;
    }

    public void setOldMembership(byte oldMembership) {

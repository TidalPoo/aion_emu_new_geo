...
public class TitleList {
    ...
    public boolean addTitle(int titleId, boolean questReward, int time) {
        ...
        if (owner != null) {
            ...
            PacketSendUtility.sendPacket(owner, new SM_TITLE_INFO(owner, false));
            return true;
        }
        return false;
    }
    ...
    public void setDisplayTitle(int titleId) {
        PacketSendUtility.sendPacket(owner, new SM_TITLE_INFO(titleId, false));
        PacketSendUtility.broadcastPacketAndReceive(owner, (new SM_TITLE_INFO(owner, titleId, false)));
        owner.getCommonData().setTitleId(titleId);
    }

    public void setBonusTitle(int bonusTitleId) {
        PacketSendUtility.sendPacket(owner, new SM_TITLE_INFO(6, bonusTitleId, false));

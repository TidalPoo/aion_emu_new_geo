...
public class PlayerCommonData extends VisibleObjectTemplate {
    ...
    private int npcExpands = CustomConfig.ENABLE_CUBE_MAX_LIMIT ? 12 : 0;
    private int warehouseNpcExpands = 0;
    private int warehouseBonusExpands = 0;
    private int advancedStigmaSlotSize = MembershipConfig.STIGMA_SLOT_QUEST == 0 ? 11 : 0;
    ...
    private int enter_world_count;
    private int securityLevel;
    private int memberLevel;
    private Timestamp timeAccessLevelExpire;
    private Timestamp timeMembershipLevelExpire;
    private int npcKills;
    private int specialNpcKills;
    private int duelWin;
    private int duelLose;
    private int powershard = 0;
    private int fly = 0;
    private int onlineTime;
    private boolean tpFly = false;
    private int die;
    private int accueseLevel;
    private boolean changeClass = false;
    private int rankTitle = 0;
    ...
    public void setDp(int dp) {
        if (getPlayer() != null) {
            ...
            this.dp = dp > maxDp || getPlayer().isInvul() ? maxDp : dp;
    ...
    public void resetRepostePoints() {
        reposteCurrent = 0;
    }
    ...
    public void setPVPPoints(int value) {
        pvpPoint = value;
    }
    ...
    public int getEnterWorldCount() {
        return enter_world_count;
    }

    public void setEnterWorldCount(int count) {
        this.enter_world_count = count;
    }
    ...
    public void setSecurityLevelExpire(Timestamp timestamp) {
        timeAccessLevelExpire = timestamp;
    }

    public void setMembershipLevelExpire(Timestamp timestamp) {
        timeMembershipLevelExpire = timestamp;
    }

    public Timestamp getTimeAccessLevelExpire() {
        return timeAccessLevelExpire;
    }

    public Timestamp getTimeMembershipLevelExpire() {
        return timeMembershipLevelExpire;
    }
    ...
    public int getSpecialNpcKills() {
        return specialNpcKills;
    }

    public void increaseSpecialNpcKills() {
        specialNpcKills++;
    }

    public void setSpecialNpcKills(int npcKills) {
        this.specialNpcKills = npcKills;
    }
    ...
    public void setDuelWin(int duelWin) {
        this.duelWin = duelWin;
    }

    public int getDuelLose() {
        return duelLose;
    }

    public void setDuelLose(int duelLose) {
    ...
    public void setPowerShard(int aInt) {
        powershard = aInt;
    }

    public int getPowershard() {
        return powershard;
    }

    public boolean isPowershard() {
        return this.powershard == 1;
    }

    public void setFly(int s) {
        fly = s;
    }
    ...
    public void setTeleportFlying(boolean b) {
        tpFly = b;
    }

    public boolean isTeleportFly() {
        return tpFly;
    }
    ...
    public int getAccueseLevel() {
        return accueseLevel;
    }

    public void setAccueseLevel(int accueseLevel) {
        this.accueseLevel = accueseLevel;
    }

    public void increaseAccuese() {
        accueseLevel++;
    }

    public void setChangeClass(boolean set) {
        this.changeClass = set;
    }
    ...
    public int getRankTitle() {
        return rankTitle;
    }

    public void setRankTitle(int titleId) {
        rankTitle = titleId;
    }
    ...
    public void setFriend(int count) {
        this.friends = count;
    }

...
public abstract class VisibleObject extends AionObject {
    ...
    public static final float VisibilityDistance = 200;

    // maxZvisibleDistance
    public static final float maxZvisibleDistance = 200;
    ...
    public String getWorldName() {
        return World.getInstance().getWorldMap(getWorldId()).getName();
    }

...
public class FindGroup {
    ...
    public int getMinLevel() {
        if (object instanceof Player) {
            return ((Creature) (object)).getLevel();
        } else if (object instanceof PlayerAlliance) {
            int minLvl = 99;
            ...
            return ((TemporaryPlayerTeam<PlayerGroupMember>) object).getMinExpPlayerLevel();
    ...
    public int getMaxLevel() {
        if (object instanceof Player) {
            ...
            return ((TemporaryPlayerTeam<PlayerGroupMember>) object).getMaxExpPlayerLevel();
        } else if (object instanceof TemporaryPlayerTeam) {
    ...
    public String getName() {
        if (object instanceof Player) {
            ...
            return ((GeneralTeam<Player, PlayerGroupMember>) object).getLeaderObject().getName();
        }
        return "";
    }
    ...
    public int getSize() {
        if (object instanceof Player) {
            ...
            return ((Team<Player, PlayerAllianceMember>) object).size();
        } else if (object instanceof PlayerGroup) {
            return ((Team<Player, PlayerGroupMember>) object).size();
        }
        return 1;
    }

...
public class Npc extends Creature {
    ...
    public void shout(final NpcShout shout, final Creature target, final Object param, int delaySeconds) {
        ...
        if (shout.getPattern() != null
                && !((AbstractAI) getAi2()).onPatternShout(shout.getWhen(), shout.getPattern(), shout.getSkillNo())) {
            return;
        }
    ...
    public void setIsEventNpc(boolean value) {
        this.isEventNpc = value;
    }
    ...
    public void set2Respawn(boolean t) {
        respawn = t;
    }

...
import static com.aionemu.gameserver.model.items.ItemSlot.SUB_HAND;
...
public enum ItemSlot {
    ...
    SUB_EQUIP(SUB_HAND.slotIdMask | RING_RIGHT.slotIdMask | EARRINGS_RIGHT.slotIdMask, true),
    ...
    public static boolean isSubEquip(int slot) {
        return (SUB_EQUIP.slotIdMask & slot) == slot;
    }

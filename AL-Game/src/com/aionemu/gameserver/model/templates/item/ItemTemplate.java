...
public class ItemTemplate extends VisibleObjectTemplate {
    ...
    public boolean isStigma() {
        return itemId > 140000000 && itemId < 140001002;
    }
    ...
    public int getItemSkinId() {
        return itemSkinId == 0 ? itemId : itemSkinId;
    }

    public void setItemSkinId(int id) {
        this.itemSkinId = id;
    }
    ...
    public boolean isManastoneAncient() {
        return getTemplateId() >= 167020000 && getTemplateId() <= 167020071;
    }

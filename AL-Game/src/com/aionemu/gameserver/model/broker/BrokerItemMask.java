...
public enum BrokerItemMask {
    ...
    WEAPON_PISTOL(1018, new BrokerContainsFilter(1018), BrokerItemMask.WEAPON, false),
    WEAPON_AETHERCANNON(1019, new BrokerContainsFilter(1019), BrokerItemMask.WEAPON, false),
    ...
    CRAFT_MATERIALS_GATHERED(6030, new BrokerContainsExtraFilter(15200), BrokerItemMask.CRAFT_MATERIALS, false),
    CRAFT_MATERIALS_LOOTED(6031, new BrokerContainsExtraFilter(15201), BrokerItemMask.CRAFT_MATERIALS, false),
    CRAFT_MATERIALS_COMPONENTS(6032, new BrokerContainsExtraFilter(15202), BrokerItemMask.CRAFT_MATERIALS, false),

        ...
        if ((slot & ItemSlot.MAIN_OR_SUB.getSlotIdMask()) != 0) {
            ...
            if (item.hasFusionedItem()) {
                ...
                if (weaponStats != null) {
                    ...
                    if (weaponType == WeaponType.ORB_2H || weaponType == WeaponType.BOOK_2H || weaponType == WeaponType.GUN_1H/*|| weaponType == WeaponType.GUN_2H ||*/ || weaponType == WeaponType.CANNON_2H || weaponType == WeaponType.HARP_2H) {

...
import static com.aionemu.gameserver.model.Race.values;
...
public enum Race {
     ...
     * Playable races
     */
    ELYOS(0, new DescriptionId(1800481), "Элиец"),
    ASMODIANS(1, new DescriptionId(1800483), "Асмодианин"),
    /**
     * Npc races
     */
    LYCAN(2),
    ...
    private Race(int raceId, DescriptionId descriptionId, String rusname) {
        this.raceId = raceId;

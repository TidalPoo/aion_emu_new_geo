...
public class Legion {
    ...
    private int legionFfaKills;
    private int allLegionKills;
    private float x;
    private float y;
    private float z;
    private boolean onlineGeneral;
    private int legionWarId;
    private int hermit = 0;
    ...
    public int getLegionFfaKills() {
        return legionFfaKills;
    }

    public void setLegionFfaKills(int legionFfaKills) {
        this.legionFfaKills = legionFfaKills;
    }

    public int getAllLegionKills() {
        return allLegionKills;
    }

    public void setAllLegionKills(int allLegionKills) {
        this.allLegionKills = allLegionKills;
    }

    public void increaseLegionKills() {
        allLegionKills++;
    }

    public void increaseFfaLegionKills() {
        legionFfaKills++;
    }
    ...
    public void setOnlineBrigadeGeneral(boolean b) {
        onlineGeneral = b;
    }

    public boolean isOnlineBrigadeGeneral() {
        return onlineGeneral;
    }

    public boolean isWar(Legion legion) {
        return getLegionWar() == legion.getLegionId();
    }

    private int getLegionWar() {
        return legionWarId;
    }
    ...
    public void setHermiint(int i) {
        hermit = i;
    }

    public int getHermiint() {
        return hermit;
    }
}

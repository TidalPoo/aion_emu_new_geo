...
import com.aionemu.gameserver.network.loginserver.clientpackets.CM_VERSION;
...
public class LsPacketHandlerFactory {
    ...
    private LsPacketHandlerFactory() {
        ...
        addPacket(new CM_PREMIUM_RESPONSE(0xA), State.AUTHED);
        addPacket(new CM_LS_PING(0xb), State.AUTHED);
        addPacket(new CM_PTRANSFER_RESPONSE(0xc), State.AUTHED);
        addPacket(new CM_VERSION(0xd), State.AUTHED);
    }

...
import com.aionemu.gameserver.network.telnet.commands.TelnetBan;
import com.aionemu.gameserver.network.telnet.commands.TelnetConfig;
import com.aionemu.gameserver.network.telnet.commands.TelnetSay;
import com.aionemu.gameserver.network.telnet.commands.TelnetServer;
import com.aionemu.gameserver.network.telnet.commands.TelnetStatus;
import com.aionemu.gameserver.network.telnet.commands.TelnetWorld;
 ...
 * @author Amiko.Yuki
 */
public final class TelnetServerHandler extends SimpleChannelUpstreamHandler implements TelnetCommandHolder {
    ...
    public void channelConnected(ChannelHandlerContext ctx, ChannelStateEvent e) throws Exception {
        ...
        e.getChannel().write("Welcome to Server Aion Online telnet console.\n");
        e.getChannel().write("It is " + new Date() + " now.\n");
        if (!NetworkConfig.TELNET_PASSWORD.isEmpty()) {
            // Ask password
    ...
    public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) {
        ...
        if (Boolean.FALSE.equals(ctx.getAttachment())) {
            if (NetworkConfig.TELNET_PASSWORD.equals(request)) {
                ctx.setAttachment(Boolean.TRUE);
                request = "";
            } else {

...
public class CM_TUNE extends AionClientPacket {
    ...
    protected void runImpl() {
        ...
        PacketSendUtility.broadcastPacket(player, new SM_ITEM_USAGE_ANIMATION(player.getObjectId(),
                item.getObjectId(), itemId, player.getMembership() >= CustomConfig.OPEN_TUNE_MEMBERSHIP_LEVEL ? CustomConfig.OPEN_TUNE_MEMBERSHIP_TIME : CustomConfig.OPEN_TUNE_TIME, 0, 0), true);
        final ItemUseObserver observer = new ItemUseObserver() {
            ...
            public void abort() {
                ...
                PacketSendUtility.broadcastPacket(player, new SM_ITEM_USAGE_ANIMATION(player.getObjectId(),
                        itemObjectId, itemId, 0, 2, 0), true);
        ...
        }, player.getMembership() >= CustomConfig.OPEN_TUNE_MEMBERSHIP_LEVEL ? CustomConfig.OPEN_TUNE_MEMBERSHIP_TIME : CustomConfig.OPEN_TUNE_TIME));
    }

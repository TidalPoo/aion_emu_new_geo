...
public class CM_TELEPORT_SELECT extends AionClientPacket {
    ...
    protected void runImpl() {
        ...
        if (player.getLifeStats().isAlreadyDead() || !RestrictionsManager.canTeleport(player)) {
            return;
        }
        ...
        if (obj != null && obj instanceof Npc) {
            ...
            if (teleport != null) {
                TeleportService2.teleport(teleport, locId, player, npc, TeleportAnimation.JUMP_AIMATION_2);
            } else {

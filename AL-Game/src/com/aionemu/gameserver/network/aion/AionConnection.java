 ...
 *
 * @author -Nemesiss-
 * @modified Alex - added hdd_serial and IPv4 List.
 */
public class AionConnection extends AConnection {
    ...
    public AionConnection(SocketChannel sc, Dispatcher d) throws IOException {
        ...
        //LoggerFactory.getLogger(AionConnection.class).info("2qeada ");
        ...
        String ip = getIP();
        log.debug("SAO connection from: " + ip);
    ...
    /**
     * Its guaranteed that closePacket will be sent before closing connection,
    ...
    /**
     * Sets Active player to new value. Update connection state to correct
     * value.
     *
     * @param player
    ...
    private class PingChecker implements Runnable {
        ...
        @Override
        public void run() {
            /*if (!"127.0.0.1".equals(AionConnection.this.getIP())) {

 ...
 *
 * @author -Nemesiss-, alexa026, Avol ;d modified by ATracer, Rolandas, Alex
 */
public class SM_INVENTORY_INFO extends AionServerPacket {
    ...
    public SM_INVENTORY_INFO(boolean isFirstPacket, List<Item> items, int npcExpandsSize, int questExpandsSize, Player player, boolean openWindow, boolean gmpanel) {
    ...
    protected void writeImpl(AionConnection con) {
        ...
        writeC(openWindow ? 1 : 0); // open window inventory

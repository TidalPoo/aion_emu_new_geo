...
public class SM_LEGION_LEAVE_MEMBER extends AionServerPacket {
    ...
    protected void writeImpl(AionConnection con) {
        ...
        writeD(0x00); // unix time for log off mb houseOwnerInfo
        writeD(msgId);
        writeS(name);
        writeS(name1);
        /*houseOwnerInfo
         <bit num="1" display="Owner"/>
         <bit num="2" display="Studio acquired"/>
         <bit num="4" display="Can bid"/>
         <bit num="8" display="Unk 0x8"/>
         <bit num="16" display="Unk 0x16"/>*/
    }
}

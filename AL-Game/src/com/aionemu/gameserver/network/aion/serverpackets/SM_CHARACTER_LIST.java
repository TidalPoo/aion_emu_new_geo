...
public class SM_CHARACTER_LIST extends PlayerInfo {
    ...
    protected void writeImpl(AionConnection con) {
        ...
        for (PlayerAccountData playerData : account.getSortedAccountsList()) {
            ...
            if (cbi != null && !account.isDeveloper() && cbi.getEnd() > System.currentTimeMillis() / 1000) {
            ...
            if (pcd.getSecurityLevel() > 0 && !account.isGameMaster()) {
                account.setGameMaster(true);
            }
            if (pcd.getMemberLevel() > 0 && !account.isPlayerMember()) {

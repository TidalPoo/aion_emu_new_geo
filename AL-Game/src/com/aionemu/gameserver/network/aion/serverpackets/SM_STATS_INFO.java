...
public class SM_STATS_INFO extends AionServerPacket {
    ...
    protected void writeImpl(AionConnection con) {
        ...
        writeH(pgs.getOffHandMAttack().getCurrent()); // [current off hand magic attack]
        ...
        writeH(pgs.getMainHandMAttack().getBase());// [base magic attack]
        writeH(pgs.getOffHandMAttack().getBase());// [base magic attack]

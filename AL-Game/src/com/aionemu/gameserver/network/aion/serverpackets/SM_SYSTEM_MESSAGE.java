...
public final class SM_SYSTEM_MESSAGE extends AionServerPacket {
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_CANT_CAST(int stateId) {
    ...
    public static SM_SYSTEM_MESSAGE STR_TITLE_BONUS_SKILL(DescriptionId id, String value1) {
        return new SM_SYSTEM_MESSAGE(1300775, id, value1);
    }
    ...
    /**
     * Teleport Statues have appeared at the entrance to Kamar and the boarding
     * site.
     */
    public static final SM_SYSTEM_MESSAGE STR_MSG_IDKamar_StartTeleporter_Spawn = new SM_SYSTEM_MESSAGE(1401913);

    /**
     * Reian Tribe supplies have been deposited in Peace Square.
     */
    public static final SM_SYSTEM_MESSAGE STR_MSG_IDKamar_YunSupply_Spawn = new SM_SYSTEM_MESSAGE(1401913);

    public static final SM_SYSTEM_MESSAGE STR_MSG_ENCHANT_ITEM_SUCCEED_NEW(DescriptionId descriptionId, int Level) {
        return new SM_SYSTEM_MESSAGE(1401681, descriptionId, Level);
    }

    public static final SM_SYSTEM_MESSAGE STR_LDF5b_6021_Out_Door_02_Despawn = new SM_SYSTEM_MESSAGE(1401691, new Object[0]);

    public static final SM_SYSTEM_MESSAGE STR_PO_DirectFiringGun_Vritra_Shot_G1_DESC = new SM_SYSTEM_MESSAGE(2281763, new Object[0]);

    public static final SM_SYSTEM_MESSAGE STR_MSG_Mercenary_Chief_Fail_01 = new SM_SYSTEM_MESSAGE(1401837, new Object[0]);

    public static final SM_SYSTEM_MESSAGE STR_MSG_5011_Mercenary_Chief_01 = new SM_SYSTEM_MESSAGE(1401828, new Object[0]);

    public static final SM_SYSTEM_MESSAGE STR_MSG_5011_Mercenary_Chief_02 = new SM_SYSTEM_MESSAGE(1401829, new Object[0]);

    public static final SM_SYSTEM_MESSAGE STR_MSG_5011_Mercenary_Chief_03 = new SM_SYSTEM_MESSAGE(1401830, new Object[0]);

    public static final SM_SYSTEM_MESSAGE STR_MSG_6011_Mercenary_Chief_01 = new SM_SYSTEM_MESSAGE(1401831, new Object[0]);

    public static final SM_SYSTEM_MESSAGE STR_MSG_6011_Mercenary_Chief_02 = new SM_SYSTEM_MESSAGE(1401832, new Object[0]);

    public static final SM_SYSTEM_MESSAGE STR_MSG_6011_Mercenary_Chief_03 = new SM_SYSTEM_MESSAGE(1401833, new Object[0]);

    public static final SM_SYSTEM_MESSAGE STR_MSG_6021_Mercenary_Chief_01 = new SM_SYSTEM_MESSAGE(1401834, new Object[0]);

    public static final SM_SYSTEM_MESSAGE STR_MSG_6021_Mercenary_Chief_02 = new SM_SYSTEM_MESSAGE(1401835, new Object[0]);

    public static final SM_SYSTEM_MESSAGE STR_MSG_6021_Mercenary_Chief_03 = new SM_SYSTEM_MESSAGE(1401836, new Object[0]);

    private final int code;
    private final Object[] params;
    private boolean npcShout = false;
    private int npcObjId = 0;
    private int textColorId = 25;
    ...
    protected void writeImpl(AionConnection con) {
        ...
        boolean test = false;
        if (test) {
            if (con.getActivePlayer() != null && con.getActivePlayer().isShowPacket()) {
                PacketSendUtility.sendMessage(con.getActivePlayer(), "code: " + code);
            }
        }
    }
}

...
public class CM_LS_CONTROL_RESPONSE extends LsClientPacket {
    ...
    public void runImpl() {
        ...
        Player admin = world.findPlayer(CustomConfig.ENABLE_CONVERT_NAME ? Util.convertName(adminName) : adminName);
        Player player = world.findPlayer(CustomConfig.ENABLE_CONVERT_NAME ? Util.convertName(playerName) : playerName);

    ...
    public void setRouteStep(RouteStep paramRouteStep1, RouteStep paramRouteStep2) {
        ...
        if (this.owner.getWalkerGroup() != null) {
            if (this.owner.getWalkerGroupShift() == null) {
                log.warn("Missing WalkerGroupShift for: " + this.owner.getNpcId());
                return;
            }
            ...
            if ((GeoDataConfig.GEO_ENABLE) && (GeoDataConfig.GEO_NPC_MOVE)) {
                localVector3f = GeoService.getInstance().getClosestCollision(this.owner, paramRouteStep2.getX(), paramRouteStep2.getY(), paramRouteStep2.getZ(), false, (byte) 0);
            ...
            if ((GeoDataConfig.GEO_ENABLE) && (GeoDataConfig.GEO_NPC_MOVE)) {
                localVector3f = GeoService.getInstance().getClosestCollision(this.owner, paramRouteStep1.getX(), paramRouteStep1.getY(), paramRouteStep1.getZ(), false, (byte) 0);
                this.pointZ = localVector3f.getZ();

...
public final class RestrictionsManager {
    ...
    /**
     * Check whether player can buy item to ingameshop - @autor Alex
     *
     * @param player
     * @param item
     * @return canBuyIngameshop
     */
    public static boolean canBuyIngameshop(Player player, IGItem item) {
        for (Restrictions restrictions : RESTRICTIONS[RestrictionMode.canBuyIngameshop.ordinal()]) {
            if (!restrictions.canBuyIngameshop(player, item)) {
                return false;
            }
        }
        return true;
     ...
     * @return canBuyIngameshop
     */
    public static boolean canShowIngameshop(Player player) {
        for (Restrictions restrictions : RESTRICTIONS[RestrictionMode.canShowIngameshop.ordinal()]) {
            if (!restrictions.canShowIngameshop(player)) {
                return false;
            }
        }
        return true;
    ...
    public static boolean canPrivateStore(Player player) {
        for (Restrictions restrictions : RESTRICTIONS[RestrictionMode.canPrivateStore.ordinal()]) {
            if (!restrictions.canPrivateStore(player)) {
                return false;
            }
        }
        return true;
    ...
    public static boolean canTeleport(Player player) {
        for (Restrictions restrictions : RESTRICTIONS[RestrictionMode.canTeleport.ordinal()]) {
            if (!restrictions.canTeleport(player)) {
                return false;
            }
        }
        return true;
    ...
    public static boolean canMove(Player player) {
        for (Restrictions restrictions : RESTRICTIONS[RestrictionMode.canMove.ordinal()]) {
            if (!restrictions.canMove(player)) {
                return false;
            }
        }
        return true;

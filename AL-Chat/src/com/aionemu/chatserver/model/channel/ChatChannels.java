...
public class ChatChannels {
    ...
    static {
        ...
        if (Config.LANG_CHAT == 1) {
            ...
            addJobChannel(Gender.MALE, PlayerClass.GUNNER, "job_Gunslinger");
            addJobChannel(Gender.MALE, PlayerClass.BARD, "job_Songweaver");
            // Female
            ...
            addJobChannel(Gender.FEMALE, PlayerClass.GUNNER, "job_Gunslinger");
            addJobChannel(Gender.FEMALE, PlayerClass.BARD, "job_Songweaver");
